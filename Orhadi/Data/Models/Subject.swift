...
final class Subject: Codable {
    ...
    static let sampleData = [
        Subject(name: "Português", teacher: "Prof. D", email: "example@email.com", schedule: Date(), startTime: Date(), endTime: Date(), place: "Sala 109"),
        Subject(name: "Biologia", teacher: "Prof. J", email: "example@email.com", schedule: Date(), startTime: Date(), endTime: Date(), place: "Sala 109"),
        Subject(name: "Química", teacher: "Prof. H", email: "example@email.com", schedule: Date(), startTime: Date(), endTime: Date(), place: "Sala 109"),
    ]
