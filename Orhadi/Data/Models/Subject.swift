...
final class Subject: Codable {
    ...
    static let sampleData = [
        Subject(name: "Português", teacher: "Prof. Mariana", email: "example@email.com", schedule: Date(), startTime: Date(), endTime: Date(), place: "Sala 109"),
        Subject(name: "Biologia", teacher: "Prof. Simone", email: "example@email.com", schedule: Date(), startTime: Date(), endTime: Date(), place: "Sala 109"),
        Subject(name: "Química", teacher: "Prof. Natália", email: "example@email.com", schedule: Date(), startTime: Date(), endTime: Date(), place: "Sala 109"),
    ]
